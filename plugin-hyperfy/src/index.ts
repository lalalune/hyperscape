...
// import { loadRPGAction } from './actions/load-rpg'; // Now loads UGC content from world - Commented out due to import issues
// RPG providers removed - will be loaded dynamically with RPG bundle

// Import minigame actions
import {
    startTaskAction,
    completeTaskAction,
    killPlayerAction,
...
export const hyperfyPlugin: Plugin = {
  ...
  actions: [
    ...
    replyAction,
    ignoreAction,
    // loadRPGAction, // Action to load RPG bundle - Commented out due to import issues
    // Minigame actions
    startTaskAction,
    completeTaskAction,
    killPlayerAction,
  ...
  providers: [
    ...
    characterProvider,
    // RPG providers removed - loaded dynamically with RPG bundle
  ],
  routes: [],
};
