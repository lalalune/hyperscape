 ...
 *
 * All timing values are in game ticks (600ms each, tile-based-MMORPG-accurate).
 ...
 * tile-based-MMORPG-accurate: 8 ticks ≈ 4.8 seconds (close to 5s, aligned to tick boundary)
 */
 ...
 * tile-based-MMORPG-accurate: 15 tiles
 */
