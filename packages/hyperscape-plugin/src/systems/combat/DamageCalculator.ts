...
export interface EquipmentStats {
  ...
  defense: number;
  ranged: number;
  // Per-style melee defence bonuses (tile-based MMORPG combat triangle)
  defenseStab?: number;
  defenseSlash?: number;
  defenseCrush?: number;
...
export class DamageCalculator {
   ...
   * @param style - Combat style for tile-based-MMORPG-accurate stat bonuses (default: "accurate")
