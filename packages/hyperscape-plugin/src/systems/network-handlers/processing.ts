...
export function handleFiremakingRequest(
  ...
  // Validate inventory slot bounds (tile-based MMORPG inventory is 28 slots: 0-27)
  if (
    payload.logsSlot < 0 ||
    payload.logsSlot > 27 ||
  ...
  // Stop player movement before lighting fire (Tile-based MMORPG: player stands still to light)
