 ...
 * - Mobs spawn in an AREA, not at a single point (tile-based-MMORPG-style)
 ...
 * - TICK-BASED timing for tile-based-MMORPG-accurate respawn mechanics
 *
 * Design:
 ...
 * - Internally converts to ticks for tile-based-MMORPG-accurate timing
...
export class RespawnManager {
  ...
  // TICK-BASED respawn timing (tile-based-MMORPG-accurate)
