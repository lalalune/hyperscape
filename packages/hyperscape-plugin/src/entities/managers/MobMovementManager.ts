 ...
 * Handles tile-based movement (tile-based-MMORPG-accurate), patrol point generation, wander targets,
...
export class MobMovementManager {
  ...
  /**
   * Emit a tile movement request (tile-based-MMORPG-accurate tick-based movement)
