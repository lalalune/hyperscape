 ...
 *
 * the tile-based MMORPG genre large NPCs:
 ...
 * one tile, matching tile-based MMORPG mechanics for boss fights and large creatures.
 *
 ...
 * tile-based MMORPG calculations (pathfinding, hunt range, etc.)
 *
