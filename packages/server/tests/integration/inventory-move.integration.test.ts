 ...
 * Verifies classic MMORPG-style SWAP behavior (not INSERT), validation, and rate limiting.
 */
...
// Simulate the classic MMORPG-style SWAP logic from InventorySystem.moveItem
function performSwap(
  ...
  // classic MMORPG-style SWAP: exchange two slots directly
  if (fromItem && toItem) {
...
describe("Inventory Move Integration - classic MMORPG-style SWAP", () => {
...
describe("Inventory Move Integration - Stackable Items", () => {
  ...
  it("swaps stackable items without merging stacks", () => {
    // classic MMORPG inventory swap doesn't merge stacks - that's a bank operation
