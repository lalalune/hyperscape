/**
 * Configuration constants for the Hyperfy plugin
 * All configurable values should be defined here to avoid hardcoding
 */

// Network Configuration
export const NETWORK_CONFIG = {
  DEFAULT_WS_URL: process.env.WS_URL || 'wss://chill.hyperfy.xyz/ws',
  DEFAULT_API_BASE: process.env.API_BASE || 'http://localhost:3333',
...
export const AGENT_CONFIG = {
  APPEARANCE_POLL_INTERVAL_MS: parseInt(process.env.APPEARANCE_POLL_INTERVAL_MS || '30000'),
  BEHAVIOR_TIME_INTERVAL_MIN_MS: parseInt(process.env.BEHAVIOR_TIME_MIN_MS || '15000'),
  BEHAVIOR_TIME_INTERVAL_MAX_MS: parseInt(process.env.BEHAVIOR_TIME_MAX_MS || '30000'),
  RANDOM_WALK_INTERVAL_MS: parseInt(process.env.RANDOM_WALK_INTERVAL_MS || '5000'),
  RANDOM_WALK_MAX_DISTANCE: parseInt(process.env.RANDOM_WALK_MAX_DISTANCE || '7'),
} as const

// Controls Configuration
export const CONTROLS_CONFIG = {
  TICK_INTERVAL_MS: parseInt(process.env.CONTROLS_TICK_INTERVAL_MS || '100'),
  NAVIGATION_STOP_DISTANCE: parseFloat(process.env.NAVIGATION_STOP_DISTANCE || '0.5'),
  FOLLOW_STOP_DISTANCE: parseFloat(process.env.FOLLOW_STOP_DISTANCE || '2.5'),
  ACTION_DEFAULT_DURATION_MS: parseInt(process.env.ACTION_DURATION_MS || '3333'),
} as const
...
export const GAME_CONFIG = {
  ...
  OBSERVATION_DURATION_MS: parseInt(process.env.OBSERVATION_DURATION_MS || '3333'),
} as const
...
export const TEST_CONFIG = {
  ...
  WAIT_DURATION_MS: parseInt(process.env.TEST_WAIT_MS || '3333'),
