...
export class Terrain extends System {
  ...
  protected chunks: Map<string, TerrainChunk>;
  protected chunkSize: number;
  protected chunkResolution: number;
  protected maxHeight: number;
  protected waterLevel: number;
  protected defaultType: TerrainType;
  protected terrainTypes: Map<number, TerrainType>;
  ...
  protected generateChunk(chunkX: number, chunkZ: number): TerrainChunk {
