...
export function createClientWorld() {
  ...
  // Register hot reloadable items
  if (import.meta.hot) {
    world.setHot(world.loader, true);
    world.setHot(world.entities, true);
    world.setHot(world.blueprints, true);
    world.setHot(world.scripts, true);
    world.setHot(world.apps, true);
    world.setHot(world.collections, true);
    world.setHot(world.settings, true);
    world.setHot(world.anchors, true);
  }
