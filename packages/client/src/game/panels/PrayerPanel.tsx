/**
 * Prayer Panel
 * tile-based MMORPG-inspired prayer interface with adaptive grid layout
 * Authentic tile-based MMORPG/RS3 style design
 * Supports drag-drop to action bar
 * Syncs with server prayer state
 *
 * Layout adapts based on panel size:
 * - Wide: 5 columns (default tile-based MMORPG style)
 * - Medium: 4 columns
 * - Narrow: 3 columns
...
/** Prayer icon component with tile-based-MMORPG-style glow effect and drag support */
function PrayerIcon({
  prayer,
  playerLevel,
  onClick,
  ...
  const buttonStyle = useMemo(
    (): React.CSSProperties => ({
      ...
      borderColor: isActive
        ...
        : isHovered && isUnlocked
          ? "rgba(183, 140, 76, 0.4)" // RS3/tile-based MMORPG gold tint on hover
          : "rgba(8, 8, 10, 0.6)",
      borderWidth: "1px",
