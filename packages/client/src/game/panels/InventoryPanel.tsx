    ...
    >
      <div className="flex flex-col h-full overflow-hidden gap-0.5 sm:gap-1">
        ...
        <div className="flex gap-0.5 sm:gap-1">
          ...
          >
            <div className="flex items-center gap-0.5 sm:gap-1">
              ...
              <span
                className="font-medium opacity-75 text-[0.563rem] sm:text-[0.625rem]"
            ...
            <span
              className="font-semibold text-[0.563rem] sm:text-[0.625rem]"
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          ...
          >
            <SortableContext
              items={currentPageItems.map(
                (_, i) => `inventory-${startIndex + i}`,
              )}
        ...
        <div className="flex flex-col gap-0.5 sm:gap-1">
          ...
          >
            <div className="flex items-center gap-0.5 sm:gap-1">
              ...
              <span
                className="font-medium text-[0.625rem] sm:text-[0.688rem]"
                style={{ color: "#fbbf24" }}
              >
                Coins
              </span>
