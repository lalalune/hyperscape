...
export function isEmbeddedMode(): boolean {
  return !!(window as { __HYPERSCAPE_EMBEDDED__?: boolean })
...
export function getEmbeddedConfig(): EmbeddedViewportConfig | null {
  return (
    (window as { __HYPERSCAPE_CONFIG__?: EmbeddedViewportConfig })
      .__HYPERSCAPE_CONFIG__ || null
  );
}
...
export function getViewportSettings(): ViewportSettings | null {
  return (
    (window as { __HYPERSCAPE_VIEWPORT_SETTINGS__?: ViewportSettings })
      .__HYPERSCAPE_VIEWPORT_SETTINGS__ || null
  );
}
