// Core types for plugin-hyperia - imports from @hyperforge/shared and @elizaos/core
...
// Import classes from hyperia (these are values)
import {
  SystemClass,
  World as WorldClass,
...
// Import canonical types from hyperia shared package
import type {
  Player,
  PlayerInput,
  PlayerStats,
...
export interface ContentBundle {
  ...
  providers?: Provider[];
  handlers?: unknown[];
  dynamicActions?: HyperiaActionDescriptor[];
  config?: {
...
export interface HyperiaActionDescriptor {
  name: string;
  description: string;
