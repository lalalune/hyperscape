...
export class PlayerMovementSystem extends EventEmitter {
  ...
  /** Shared BFSPathfinder instance - same algorithm used by server for rules-accurate movement */
   ...
   *
   * Uses the same rules-accurate pathfinding algorithm as the server:
