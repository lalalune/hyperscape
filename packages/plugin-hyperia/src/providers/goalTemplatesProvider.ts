/**
 * goalTemplatesProvider - Structured goal templates for tile-based MMORPG beginner flows
 *
 ...
 *
 * Goal templates represent common tile-based MMORPG activities:
 * - Woodcutting basics
...
// ============================================================================
// GOAL TEMPLATES - tile-based MMORPG Beginner Flows
// ============================================================================
...
export const goalTemplatesProvider: Provider = {
  name: "goalTemplates",
  description:
    "Structured goal templates for tile-based MMORPG beginner activities",
  dynamic: true,
