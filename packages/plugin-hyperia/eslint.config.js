...
export default [
  ...
  },
  {
    ...
    languageOptions: {
      globals: {
        // Browser/DOM globals needed by Hyperia
        ...
        _emscripten_bind_PxHeightFieldGeometry_PxHeightFieldGeometry_1:
          "readonly",
        _emscripten_bind_PxHeightFieldGeometry_PxHeightFieldGeometry_2:
          "readonly",
        _emscripten_bind_PxHeightFieldGeometry_PxHeightFieldGeometry_3:
          "readonly",
        _emscripten_bind_PxHeightFieldGeometry_PxHeightFieldGeometry_4:
          "readonly",
        ...
        _emscripten_bind_PxRigidBodyExt_computeVelocityDeltaFromImpulse_6:
          "readonly",
        _emscripten_bind_PxRigidBodyExt_computeVelocityDeltaFromImpulse_7:
          "readonly",
        _emscripten_bind_PxTetrahedronMeshDesc_PxTetrahedronMeshDesc_1:
          "readonly",
  ...
  },
  {
    ...
    rules: {
      ...
      "@typescript-eslint/no-unused-vars": [
        ...
        {
          argsIgnorePattern:
            "^_|^runtime$|^message$|^state$|^playerId$|^updates$|^callback$|^data$|^world$|^key$|^value$|^pattern$|^id$|^broadcast$",
          varsIgnorePattern:
            "^_|^mock|^impostor$|^Vector3$|^setGameState$|^Memory$|^hyperiaPlugin$|^TestCase$|^world$|^HyperiaWorld$|^messageReceived$|^describe$|^it$|^expect$|^testMessage$|^fireEvent$|^waitFor$|^id$|^HyperiaService$|^logger$|^serviceInstance$|^afterEach$|^createMockWorld$|^beforeEach$|^ModelType$|^SimulationConfig$|^gameState$|^State$|^HandlerCallback$|^createUniqueUuid$",
