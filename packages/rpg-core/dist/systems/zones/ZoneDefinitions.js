...
exports.ZONE_DEFINITIONS = exports.ZoneType = void 0;
exports.getZoneAt = getZoneAt;
exports.getZonesByTheme = getZonesByTheme;
exports.getConnectedZones = getConnectedZones;
exports.isInPvPZone = isInPvPZone;
exports.getSkillMultiplier = getSkillMultiplier;
const ResourceDefinitions_1 = require("../resources/ResourceDefinitions");
...
(function (ZoneType) {
    ...
    ZoneType["RESOURCE_FOREST"] = "resource_forest";
    ZoneType["MINING_GUILD"] = "mining_guild";
    ZoneType["FISHING_GUILD"] = "fishing_guild";
})(ZoneType || (exports.ZoneType = ZoneType = {}));
exports.ZONE_DEFINITIONS = {
    [ZoneType.LUMBRIDGE]: {
        ...
        features: {
            ...
            safeZone: true,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.COOKING]: 1.1, // Slightly faster cooking in town
            },
        },
        resources: [
            {
                resourceType: ResourceDefinitions_1.ResourceType.TREE_NORMAL,
                density: 0.3,
                minLevel: 1,
            ...
            {
                resourceType: ResourceDefinitions_1.ResourceType.FISHING_NET,
                density: 0.1,
                minLevel: 1,
            ...
            {
                resourceType: ResourceDefinitions_1.ResourceType.ROCK_CLAY,
                density: 0.05,
                minLevel: 1,
    ...
    [ZoneType.DRAYNOR]: {
        ...
        features: {
            ...
            safeZone: true,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.WOODCUTTING]: 1.1,
                [SkillDefinitions_1.SkillType.FISHING]: 1.1,
            },
        },
        resources: [
            {
                resourceType: ResourceDefinitions_1.ResourceType.TREE_WILLOW,
                density: 0.4,
                minLevel: 30,
            ...
            {
                resourceType: ResourceDefinitions_1.ResourceType.FISHING_BAIT,
                density: 0.1,
                minLevel: 20,
                clusterSize: { min: 1, max: 2 },
            },
    ...
    [ZoneType.VARROCK]: {
        ...
        features: {
            ...
            safeZone: true,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.SMITHING]: 1.2,
                [SkillDefinitions_1.SkillType.MINING]: 1.1,
            },
        },
        resources: [
            {
                resourceType: ResourceDefinitions_1.ResourceType.ROCK_IRON,
                density: 0.3,
                minLevel: 15,
                clusterSize: { min: 2, max: 5 },
            ...
            {
                resourceType: ResourceDefinitions_1.ResourceType.ROCK_COAL,
                density: 0.2,
                minLevel: 30,
                clusterSize: { min: 1, max: 3 },
            },
            {
                resourceType: ResourceDefinitions_1.ResourceType.ROCK_COPPER,
                density: 0.15,
                minLevel: 1,
                clusterSize: { min: 2, max: 4 },
            },
            {
                resourceType: ResourceDefinitions_1.ResourceType.ROCK_TIN,
                density: 0.15,
                minLevel: 1,
                clusterSize: { min: 2, max: 4 },
            },
            {
                resourceType: ResourceDefinitions_1.ResourceType.TREE_OAK,
                density: 0.1,
                minLevel: 15,
                clusterSize: { min: 1, max: 3 },
            },
    ...
    [ZoneType.FALADOR]: {
        ...
        features: {
            ...
            safeZone: true,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.CRAFTING]: 1.2,
                [SkillDefinitions_1.SkillType.SMITHING]: 1.1,
                [SkillDefinitions_1.SkillType.PRAYER]: 1.1,
            },
        },
        resources: [
            {
                resourceType: ResourceDefinitions_1.ResourceType.TREE_MAPLE,
                density: 0.1,
                minLevel: 45,
                clusterSize: { min: 1, max: 2 },
            },
            ...
            {
                resourceType: ResourceDefinitions_1.ResourceType.ROCK_GOLD,
                density: 0.05,
                minLevel: 40,
                clusterSize: { min: 1, max: 2 },
    ...
    [ZoneType.BARBARIAN_VILLAGE]: {
        ...
        features: {
            ...
            safeZone: false,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.ATTACK]: 1.1,
                [SkillDefinitions_1.SkillType.STRENGTH]: 1.1,
                [SkillDefinitions_1.SkillType.DEFENCE]: 1.1,
            },
        },
        resources: [
            {
    ...
    [ZoneType.WILDERNESS]: {
        ...
        features: {
            ...
            safeZone: false,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.MINING]: 1.5,
                [SkillDefinitions_1.SkillType.WOODCUTTING]: 1.3,
            },
            environmentEffects: ['darkness', 'fog', 'danger'],
        },
        resources: [
            {
                resourceType: ResourceDefinitions_1.ResourceType.TREE_YEW,
                density: 0.02,
                minLevel: 60,
                clusterSize: { min: 1, max: 2 },
            },
            {
                resourceType: ResourceDefinitions_1.ResourceType.TREE_MAGIC,
                density: 0.005,
                minLevel: 75,
                clusterSize: { min: 1, max: 1 },
            },
            {
                resourceType: ResourceDefinitions_1.ResourceType.ROCK_MITHRIL,
                density: 0.08,
                minLevel: 55,
                clusterSize: { min: 1, max: 3 },
            },
            {
                resourceType: ResourceDefinitions_1.ResourceType.ROCK_ADAMANT,
                density: 0.03,
                minLevel: 70,
                clusterSize: { min: 1, max: 2 },
            },
            {
                resourceType: ResourceDefinitions_1.ResourceType.ROCK_RUNITE,
                density: 0.01,
                minLevel: 85,
                clusterSize: { min: 1, max: 1 },
    ...
    [ZoneType.RESOURCE_FOREST]: {
        ...
        features: {
            ...
            safeZone: true,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.WOODCUTTING]: 1.5,
            },
        },
        resources: [
            {
    ...
    [ZoneType.MINING_GUILD]: {
        ...
        features: {
            ...
            safeZone: true,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.MINING]: 2.0,
            },
        },
        resources: [
            {
    ...
    [ZoneType.FISHING_GUILD]: {
        ...
        features: {
            ...
            safeZone: true,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.FISHING]: 2.0,
            },
        },
        resources: [
            {
                resourceType: ResourceDefinitions_1.ResourceType.FISHING_CAGE,
                density: 0.5,
                minLevel: 40,
                clusterSize: { min: 3, max: 6 },
            },
            {
                resourceType: ResourceDefinitions_1.ResourceType.FISHING_HARPOON,
                density: 0.3,
                minLevel: 50,
                clusterSize: { min: 2, max: 4 },
            },
    ...
    [ZoneType.KARAMJA]: {
        type: ZoneType.KARAMJA,
        name: 'Karamja',
        description: 'A tropical island with dangerous jungle and volcano',
        bounds: {
            minX: 200,
            maxX: 300,
            minZ: -200,
        ...
        features: {
            ...
            safeZone: false,
            skillMultipliers: {
                [SkillDefinitions_1.SkillType.FISHING]: 1.2,
                [SkillDefinitions_1.SkillType.WOODCUTTING]: 1.1,
            },
        },
        resources: [
        ...
        landmarks: [
            {
                ...
                z: -150,
                type: 'dungeon',
                description: 'Entrance to a dangerous volcano',
            },
            {
                name: 'General Store',
                x: 220,
    ...
    [ZoneType.CAMELOT]: {
        type: ZoneType.CAMELOT,
        name: 'Camelot',
        description: 'A grand castle city ruled by knights',
        bounds: {
            minX: -300,
            maxX: -200,
            minZ: 200,
        ...
        landmarks: [
            {
                ...
                z: 250,
                type: 'building',
                description: 'The great castle of Camelot',
            },
            {
                name: 'Camelot Bank',
                x: -240,
                z: 240,
                type: 'bank',
                description: 'Royal bank of Camelot',
            },
            {
                name: 'Magic Shop',
                x: -260,
                z: 230,
                type: 'shop',
                description: 'Mystic items and runes',
            },
        ],
    },
};
...
function getZoneAt(x, z) {
    for (const zone of Object.values(exports.ZONE_DEFINITIONS)) {
...
function getZonesByTheme(theme) {
    return Object.values(exports.ZONE_DEFINITIONS).filter(zone => zone.theme === theme);
}
function getConnectedZones(zoneType) {
    const zone = exports.ZONE_DEFINITIONS[zoneType];
    return zone ? zone.connections.map(conn => conn.zoneType) : [];
}
function isInPvPZone(x, z) {
    const zone = getZoneAt(x, z);
    return zone ? zone.features.pvpEnabled : false;
}
function getSkillMultiplier(x, z, skill) {
    const zone = getZoneAt(x, z);
    return zone?.features.skillMultipliers?.[skill] || 1.0;
}
//# sourceMappingURL=ZoneDefinitions.js.map