...
class EquipmentBonusCalculator {
    ...
    calculateWeightReduction(equipment) {
        ...
        const gracefulPieces = Object.values(equipment).filter(item => item && item.name.toLowerCase().includes('graceful')).length;
        ...
        const cape = equipment[types_1.EquipmentSlot.CAPE];
        if (cape) {
        ...
        // Boots of lightness
        const boots = equipment[types_1.EquipmentSlot.BOOTS];
...
exports.EquipmentBonusCalculator = EquipmentBonusCalculator;
//# sourceMappingURL=EquipmentBonusCalculator.js.map