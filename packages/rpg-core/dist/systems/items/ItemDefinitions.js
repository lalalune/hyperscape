...
exports.ITEM_DEFINITIONS = exports.EquipmentSlot = exports.ItemRarity = exports.ItemCategory = void 0;
exports.getItemDefinition = getItemDefinition;
exports.getItemsByCategory = getItemsByCategory;
exports.getItemsByRarity = getItemsByRarity;
exports.getItemsByEquipmentSlot = getItemsByEquipmentSlot;
exports.getTradeableItems = getTradeableItems;
exports.getStackableItems = getStackableItems;
exports.canPlayerEquipItem = canPlayerEquipItem;
...
(function (ItemRarity) {
    ...
    ItemRarity["VERY_RARE"] = "very_rare";
    ItemRarity["ULTRA_RARE"] = "ultra_rare";
...
exports.ITEM_DEFINITIONS = {
    ...
    bronze_dagger: {
        ...
        requirements: [{ skill: SkillDefinitions_1.SkillType.ATTACK, level: 1 }],
        stats: {
            attackBonus: 1,
            strengthBonus: 1,
            weight: 0.5,
    ...
    steel_sword: {
        ...
        tradeable: true,
        equipmentSlot: EquipmentSlot.WEAPON,
        requirements: [{ skill: SkillDefinitions_1.SkillType.ATTACK, level: 5 }],
        stats: {
            attackBonus: 21,
            strengthBonus: 20,
            weight: 1.4,
    ...
    mithril_sword: {
        ...
        tradeable: true,
        equipmentSlot: EquipmentSlot.WEAPON,
        requirements: [{ skill: SkillDefinitions_1.SkillType.ATTACK, level: 20 }],
        stats: {
            attackBonus: 35,
            strengthBonus: 34,
            weight: 1.0,
    ...
    adamant_sword: {
        ...
        tradeable: true,
        equipmentSlot: EquipmentSlot.WEAPON,
        requirements: [{ skill: SkillDefinitions_1.SkillType.ATTACK, level: 30 }],
        stats: {
            attackBonus: 50,
            strengthBonus: 49,
            weight: 1.6,
    ...
    rune_sword: {
        ...
        tradeable: true,
        equipmentSlot: EquipmentSlot.WEAPON,
        requirements: [{ skill: SkillDefinitions_1.SkillType.ATTACK, level: 40 }],
        stats: {
            attackBonus: 67,
            strengthBonus: 66,
            weight: 1.8,
    ...
    bronze_helmet: {
        ...
        requirements: [{ skill: SkillDefinitions_1.SkillType.DEFENCE, level: 1 }],
        stats: {
            defenceBonus: 6,
            weight: 1.0,
        },
    ...
    attack_potion: {
        ...
        consumable: {
            effects: [
                {
                    skill: SkillDefinitions_1.SkillType.ATTACK,
                    boost: 3,
    ...
    strength_potion: {
        ...
        consumable: {
            effects: [
                {
                    skill: SkillDefinitions_1.SkillType.STRENGTH,
                    boost: 3,
                    duration: 5,
                },
            ],
    ...
    bronze_pickaxe: {
        ...
        tradeable: true,
        equipmentSlot: EquipmentSlot.WEAPON,
        requirements: [{ skill: SkillDefinitions_1.SkillType.MINING, level: 1 }],
        stats: {
            attackBonus: 1,
            weight: 2.0,
        },
...
function getItemDefinition(itemId) {
    return exports.ITEM_DEFINITIONS[itemId] || null;
}
function getItemsByCategory(category) {
    return Object.values(exports.ITEM_DEFINITIONS).filter(item => item.category === category);
}
function getItemsByRarity(rarity) {
    return Object.values(exports.ITEM_DEFINITIONS).filter(item => item.rarity === rarity);
}
function getItemsByEquipmentSlot(slot) {
    return Object.values(exports.ITEM_DEFINITIONS).filter(item => item.equipmentSlot === slot);
}
function getTradeableItems() {
    return Object.values(exports.ITEM_DEFINITIONS).filter(item => item.tradeable);
}
function getStackableItems() {
    return Object.values(exports.ITEM_DEFINITIONS).filter(item => item.stackable);
}
function canPlayerEquipItem(playerLevels, item) {
