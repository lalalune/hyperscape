...
exports.RESOURCE_DEFINITIONS = exports.ResourceType = void 0;
exports.getResourcesBySkill = getResourcesBySkill;
exports.getResourcesByRarity = getResourcesByRarity;
exports.canHarvestResource = canHarvestResource;
const SkillDefinitions_1 = require("../skills/SkillDefinitions");
var ResourceType;
(function (ResourceType) {
    // Trees (Woodcutting)
    ResourceType["TREE_NORMAL"] = "tree_normal";
    ResourceType["TREE_OAK"] = "tree_oak";
    ResourceType["TREE_WILLOW"] = "tree_willow";
    ResourceType["TREE_MAPLE"] = "tree_maple";
    ResourceType["TREE_YEW"] = "tree_yew";
    ResourceType["TREE_MAGIC"] = "tree_magic";
    // Rocks (Mining)
    ResourceType["ROCK_CLAY"] = "rock_clay";
    ResourceType["ROCK_COPPER"] = "rock_copper";
    ResourceType["ROCK_TIN"] = "rock_tin";
    ResourceType["ROCK_IRON"] = "rock_iron";
    ResourceType["ROCK_COAL"] = "rock_coal";
    ResourceType["ROCK_GOLD"] = "rock_gold";
    ResourceType["ROCK_MITHRIL"] = "rock_mithril";
    ResourceType["ROCK_ADAMANT"] = "rock_adamant";
    ResourceType["ROCK_RUNITE"] = "rock_runite";
    // Fishing Spots
    ResourceType["FISHING_NET"] = "fishing_net";
    ResourceType["FISHING_BAIT"] = "fishing_bait";
    ResourceType["FISHING_CAGE"] = "fishing_cage";
    ResourceType["FISHING_HARPOON"] = "fishing_harpoon";
...
exports.RESOURCE_DEFINITIONS = {
    ...
    [ResourceType.TREE_NORMAL]: {
        ...
        skill: SkillDefinitions_1.SkillType.WOODCUTTING,
        levelRequired: 1,
    ...
    [ResourceType.ROCK_CLAY]: {
        ...
        skill: SkillDefinitions_1.SkillType.MINING,
        levelRequired: 1,
    ...
    [ResourceType.FISHING_NET]: {
        ...
        skill: SkillDefinitions_1.SkillType.FISHING,
        levelRequired: 1,
        baseHarvestTime: 3000,
...
// Helper functions
function getResourcesBySkill(skill) {
    return Object.values(exports.RESOURCE_DEFINITIONS).filter(resource => resource.skill === skill);
}
function getResourcesByRarity(rarity) {
    return Object.values(exports.RESOURCE_DEFINITIONS).filter(resource => resource.rarity === rarity);
}
function canHarvestResource(resource, playerLevel, hasTool) {
    return playerLevel >= resource.levelRequired && (hasTool || !resource.toolRequired);
}
//# sourceMappingURL=ResourceDefinitions.js.map