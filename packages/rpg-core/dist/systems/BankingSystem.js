...
exports.BankingSystem = void 0;
const sdk_1 = require("@hyperfy/sdk");
const ItemRegistry_1 = require("./inventory/ItemRegistry");
class BankingSystem extends sdk_1.System {
    constructor(world) {
        super(world);
        this.bankAccounts = new Map();
        this.bankBooths = new Set();
        this.playerBankOpen = new Map();
        // Persistence
        ...
        try {
            ...
            if (bankItems.length > 0) {
                ...
                for (const item of bankItems) {
                    if (currentTab >= account.tabs.length)
                        break;
...
exports.BankingSystem = BankingSystem;
BankingSystem.DEFAULT_BANK_SIZE = 816; // 8 tabs * 102 slots per tab
BankingSystem.SLOTS_PER_TAB = 102;
BankingSystem.DEFAULT_TABS = 8;
BankingSystem.MAX_PIN_ATTEMPTS = 3;
BankingSystem.PIN_LOCKOUT_TIME = 300000; // 5 minutes in milliseconds
//# sourceMappingURL=BankingSystem.js.map