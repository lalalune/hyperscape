...
exports.WorldInitializer = void 0;
const WorldGenerator_1 = require("./WorldGenerator");
class WorldInitializer {
    constructor(world) {
        this.initialized = false;
        this.world = world;
        this.generator = new WorldGenerator_1.WorldGenerator(world);
    }
    /**
     ...
     * Create initial quests
     */
    async createInitialQuests() {
        const questSystem = this.world.getSystem('quest');
        if (!questSystem)
            return;
     ...
     * Set up Grand Exchange
     */
    async setupGrandExchange() {
        const grandExchange = this.world.getSystem('grandExchange');
        if (!grandExchange)
            return;
    ...
    async startWorldSystems() {
        ...
        const resourceSystem = this.world.getSystem('resourceSpawn');
        if (resourceSystem) {
...
exports.WorldInitializer = WorldInitializer;
//# sourceMappingURL=WorldInitializer.js.map