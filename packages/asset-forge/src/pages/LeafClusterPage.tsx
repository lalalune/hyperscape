  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute top-4 left-4 flex flex-col gap-2">
          <div className="bg-bg-secondary rounded-lg p-3 ">
            <h2 className="font-display text-lg font-medium tracking-tight text-white mb-2 flex items-center gap-2">
            ...
            <button
              ...
              className="w-full px-3 py-2 bg-success text-white rounded flex items-center justify-center gap-2 hover:bg-success/80 disabled:opacity-50"
            >
              <RefreshCw
        ...
        {stats && (
          <div className="absolute top-4 right-4 bg-bg-secondary rounded-lg p-3 ">
            ...
            <div className="text-xs text-text-primary space-y-1">
              ...
              <div>
                Stems:{" "}
                <span className="text-accent-ember">{stats.stemCount}</span>
              </div>
              <div>
                Clusters:{" "}
                <span className="text-success">{stats.clusterCount}</span>
              </div>
              <div>
                Avg Leaves/Cluster:{" "}
              ...
              <div>
                Leaves Culled:{" "}
                <span className="text-error">{stats.leavesCulled}</span>
              </div>
              <div>
                Reduction:{" "}
      ...
      <div className="w-80 bg-bg-secondary border-l border-border-primary overflow-y-auto">
        <div className="p-4">
          <h3 className="font-display text-lg font-medium tracking-tight text-white mb-4 flex items-center gap-2">
          ...
          <div className="bg-bg-secondary rounded p-3">
            <h4 className="font-display text-sm font-medium tracking-tight text-success mb-2">
              SpeedTree Approach
            </h4>
