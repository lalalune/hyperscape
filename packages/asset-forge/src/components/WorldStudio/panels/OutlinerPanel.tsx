...
const TYPE_ICON_COLORS: Record<string, string> = {
  ...
  lore: "#9b8ec4",
  loreEntries: "#9b8ec4",
  difficultyZone: "#FF7A00",
  difficultyZones: "#FF7A00",
  customPlacement: "#5BA6FF",
  customPlacements: "#5BA6FF",
  layers: "#5BA6FF",
  chunks: "#8b9467",
  chunk: "#8b9467",
  spawnPoint: "#4ec46e",
  ...
  sfxTrigger: "#8a7cb0",
  gameEntities: "#5BA6FF",
  gameCharacters: "#2D8CFF",
  gameCreatures: "#E84A4A",
  gameNpcs: "#2D8CFF",
  gameNpc: "#2D8CFF",
  gameQuestNpcs: "#D4AF37",
  gameShopkeepers: "#4ec46e",
  gameServiceNpcs: "#5BA6FF",
  gameMobs: "#E84A4A",
  gameBosses: "#FF7A00",
  gameStations: "#D4AF37",
  gameStation: "#D4AF37",
  gameCraftingStations: "#D4AF37",
  gameServiceStations: "#5BA6FF",
  gameOtherStations: "#D4AF37",
  gameResources: "#4FDD96",
  gameResource: "#4FDD96",
  gameMining: "#8b9467",
  gameWoodcutting: "#6b9e5a",
  gameOtherResources: "#4FDD96",
  gameMobSpawns: "#E84A4A",
  gameMobSpawn: "#E84A4A",
  gameFishing: "#2D8CFF",
  gameAreas: "#D4AF37",
  region: "#FF7A00",
...
function getTypeIconColor(
  ...
  const schema =
    registry.get(nodeType) ?? registry.getBySelectionType(nodeType);
  return schema ? schema.color : "#7A7A82";
}
