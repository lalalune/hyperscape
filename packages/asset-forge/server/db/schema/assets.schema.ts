...
import { pgTable, uuid, varchar, text, timestamp, jsonb, bigint, integer, index } from 'drizzle-orm/pg-core'
...
export const assets = pgTable('assets', {
  ...
  parentAssetId: uuid('parent_asset_id').references((): any => assets.id, { onDelete: 'set null' }),
