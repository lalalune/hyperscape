...
- **classic low-poly fantasy aesthetic** by default
...
```json
{
  ...
  "tier": 1,
  "color": "#CD7F32",
  "stylePrompt": "bronze metal texture, copper brown color, slightly dull metallic finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 2,
  "color": "#C0C0C0",
  "stylePrompt": "steel metal texture, silver gray color, polished metallic finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 3,
  "color": "#4169E1",
  "stylePrompt": "mithril metal texture, blue-gray color with magical shimmer, fantasy metallic finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 1,
  "color": "#DEB887",
  "stylePrompt": "light wood texture, natural pine color, basic wooden finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 2,
  "color": "#8B4513",
  "stylePrompt": "oak wood texture, medium brown color, solid wooden finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 3,
  "color": "#9ACD32",
  "stylePrompt": "willow wood texture, pale yellow-green color, flexible wooden finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 1,
  "color": "#8B4513",
  "stylePrompt": "brown leather texture, natural cowhide, worn leather finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 2,
  "color": "#654321",
  "stylePrompt": "hardened brown leather texture, reinforced cowhide, sturdy leather finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 3,
  "color": "#8B4513",
  "stylePrompt": "studded leather texture, brown leather with metal studs, reinforced leather finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 10,
  "color": "#fa0000",
  "stylePrompt": "Dragon metal texture, red with matte finish, classic low-poly fantasy style",
...
**Example**: `"bronze metal texture, copper brown color, slightly dull metallic finish, classic low-poly fantasy style"`
...
4. **Art Style**: classic low-poly fantasy style, low-poly, realistic
...
```json
{
  ...
  "tier": 8,
  "color": "#00FFFF",
  "stylePrompt": "crystalline material texture, transparent cyan color, magical shimmer, glowing effect, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 7,
  "color": "#1C1C1C",
  "stylePrompt": "obsidian volcanic glass texture, glossy black color with purple reflections, sharp edges, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 4,
  "color": "#FFD700",
  "stylePrompt": "gold metal texture, bright yellow-gold color, highly polished metallic finish, classic low-poly fantasy style",
...
```json
{
  ...
  "tier": 4,
  "color": "#C04000",
  "stylePrompt": "mahogany wood texture, rich reddish-brown color, fine grain pattern, polished wooden finish, classic low-poly fantasy style",
...
```javascript
const template = templates.classic
...
{
  "templates": {
    "classic": "${materialId} texture, classic low-poly fantasy style, simple textures",
