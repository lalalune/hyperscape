...
┌─────────────────────────────────────┐
│   Game Style Prompt                 │
│   + "low-poly tile-based MMORPG style"      │
└──────────────┬──────────────────────┘
               ↓
┌─────────────────────────────────────┐
│   Prompt Enhancement                 │
...
3. **Style Modifier**: Game art style (tile-based MMORPG, realistic, stylized)
...
low-poly tile-based MMORPG style with simple geometry and vibrant metallic sheen"
```
...
// → "iron sword, low-poly tile-based MMORPG style"
```
...
front view on neutral background, low-poly tile-based MMORPG style"
```
...
low-poly tile-based MMORPG style with simple crossguard and leather-wrapped handle"
```
...
hollow interior, no armor stand, low-poly tile-based MMORPG style"
```
...
const weaponMaterials = [
  { id: 'bronze', name: 'Bronze', stylePrompt: 'bronze texture, low-poly tile-based MMORPG style' },
  { id: 'iron', name: 'Iron', stylePrompt: 'iron texture, low-poly tile-based MMORPG style' },
  { id: 'steel', name: 'Steel', stylePrompt: 'steel texture, low-poly tile-based MMORPG style' },
  { id: 'mithril', name: 'Mithril', stylePrompt: 'mithril texture, low-poly tile-based MMORPG style' },
  { id: 'adamant', name: 'Adamant', stylePrompt: 'adamant texture, low-poly tile-based MMORPG style' },
  { id: 'rune', name: 'Rune', stylePrompt: 'rune texture, low-poly tile-based MMORPG style' }
]
```
...
{
  "customOverrides": {
    "mithril": "Mithril texture with blue-silver sheen and magical glow, tile-based MMORPG style"
  }
}
```
...
Low-poly tile-based MMORPG style with simple geometry and vibrant colors."
```
...
Low-poly tile-based MMORPG style with clean geometry."
```
...
Low-poly tile-based MMORPG style with vibrant red color and minimal geometry."
```
...
await createMaterialOverride(
  'dragon',
  'Dragon scale texture with iridescent sheen and mystical glow, tile-based MMORPG style'
)
```
...
**Bad**: "Wooden bow"
**Good**: "Wooden longbow, low-poly tile-based MMORPG style with simple geometry"
...
```
"Low-poly tile-based MMORPG 2007 style with SIMPLE GEOMETRY (under 500 polygons),
