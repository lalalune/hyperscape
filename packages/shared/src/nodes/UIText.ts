...
import type { UITextData, DisplayType, TextAlign, FontWeight, FlexBasis, EdgeValue, UIContext } from '../types/nodes'
...
export class UIText extends Node {
  ...
  constructor(data: UITextData = {}) {
    ...
    this.fontSize = data.fontSize ?? defaults.fontSize
    this.color = data.color ?? defaults.color
    this.lineHeight = data.lineHeight ?? defaults.lineHeight
    this.textAlign = data.textAlign ?? (defaults.textAlign as TextAlign)
  ...
  set textAlign(value: TextAlign | undefined) {
    if (value === undefined) value = defaults.textAlign as TextAlign
