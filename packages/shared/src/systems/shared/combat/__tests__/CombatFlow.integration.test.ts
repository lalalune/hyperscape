...
// Type alias for test world that satisfies CombatSystem requirements
type CombatSystemWorld = World;
...
describe("CombatFlow Integration", () => {
  ...
  beforeEach(() => {
    ...
    combatSystem = new CombatSystem(world as unknown as CombatSystemWorld);
  });
