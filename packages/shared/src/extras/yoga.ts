...
export const Display = {} as Record<string, YogaDisplay>
export const FlexDirection: Record<string, unknown> = {}
export const JustifyContent: Record<string, unknown> = {}
export const AlignItems: Record<string, unknown> = {}
export const AlignContent: Record<string, unknown> = {}
export const FlexWrap: Record<string, unknown> = {}
