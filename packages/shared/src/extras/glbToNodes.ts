...
//   interface MaterialWithWind extends Omit<THREE.Material, 'onBeforeCompile'> {
//     hasWind?: boolean;
//     onBeforeCompile?: (shader: ShaderData) => void;
//   }
...
//   const material = mesh.material as MaterialWithWind
//   if (material.hasWind) return
//   material.hasWind = true
//   material.onBeforeCompile = (shader: ShaderData) => {
