/**
 * Character Database (Unified Mobs + NPCs)
 *
 * ALL character data is loaded from JSON manifests at runtime by DataManager.
 * This keeps character definitions data-driven and separate from code.
 *
 ...
 * 1. Add entry to world/assets/manifests/mobs.json or npcs.json
 ...
 *
 * DO NOT add character data here - keep it in JSON!
 */
...
/**
 * Character Database - Populated at runtime from JSON manifests
