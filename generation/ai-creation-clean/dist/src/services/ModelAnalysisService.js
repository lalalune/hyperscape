...
class ModelAnalysisService {
     ...
     */
    async analyzeWeapon(modelUrl, weaponType) {
     ...
     */
    async analyzeArmor(modelUrl, armorSlot) {
     ...
     */
    async analyzeForRigging(modelUrl, creatureType) {
     ...
     */
    async analyzeBuilding(modelUrl, buildingType) {
     ...
     */
    detectWeaponHardpoints(geometry, bounds, weaponType) {
     ...
     */
    determineArmorPlacement(geometry, bounds, armorSlot) {
        const placement = {
            slot: armorSlot,
     ...
     */
    generateRig(geometry, bounds, creatureType) {
        const bones = [];
        switch (creatureType) {
            case 'biped':
                // Generate humanoid rig
                bones.push({ name: 'root', position: bounds.center, rotation: { x: 0, y: 0, z: 0, w: 1 } }, { name: 'spine', position: { ...bounds.center, y: bounds.center.y + bounds.size.y * 0.1 }, rotation: { x: 0, y: 0, z: 0, w: 1 }, parent: 'root' }, { name: 'chest', position: { ...bounds.center, y: bounds.center.y + bounds.size.y * 0.3 }, rotation: { x: 0, y: 0, z: 0, w: 1 }, parent: 'spine' }, { name: 'head', position: { ...bounds.center, y: bounds.max.y - bounds.size.y * 0.1 }, rotation: { x: 0, y: 0, z: 0, w: 1 }, parent: 'chest' });
                break;
            case 'quadruped':
                // Generate four-legged rig
                bones.push({ name: 'root', position: bounds.center, rotation: { x: 0, y: 0, z: 0, w: 1 } }, { name: 'spine_front', position: { ...bounds.center, x: bounds.max.x - bounds.size.x * 0.2 }, rotation: { x: 0, y: 0, z: 0, w: 1 }, parent: 'root' }, { name: 'spine_back', position: { ...bounds.center, x: bounds.min.x + bounds.size.x * 0.2 }, rotation: { x: 0, y: 0, z: 0, w: 1 }, parent: 'root' }, { name: 'head', position: { x: bounds.max.x, y: bounds.center.y + bounds.size.y * 0.2, z: bounds.center.z }, rotation: { x: 0, y: 0, z: 0, w: 1 }, parent: 'spine_front' });
                break;
            case 'flying':
                // Generate flying creature rig
                bones.push({ name: 'root', position: bounds.center, rotation: { x: 0, y: 0, z: 0, w: 1 } }, { name: 'body', position: bounds.center, rotation: { x: 0, y: 0, z: 0, w: 1 }, parent: 'root' }, { name: 'wing_left', position: { ...bounds.center, x: bounds.min.x }, rotation: { x: 0, y: 0, z: 0, w: 1 }, parent: 'body' }, { name: 'wing_right', position: { ...bounds.center, x: bounds.max.x }, rotation: { x: 0, y: 0, z: 0, w: 1 }, parent: 'body' });
                break;
        }
        return {
     ...
     * Analyze building structure
     */
    analyzeBuildingStructure(geometry, bounds, buildingType) {
        const result = {
            buildingType,
            entryPoints: [],
            functionalAreas: [],
     ...
     */
    getDefaultAnimations(creatureType) {
        switch (creatureType) {
            case 'biped':
...
//# sourceMappingURL=ModelAnalysisService.js.map